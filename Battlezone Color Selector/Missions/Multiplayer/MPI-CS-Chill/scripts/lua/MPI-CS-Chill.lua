...
local color = require("color_functions")
...
function Start()
	...
	print("File: mpinstant.lua converted by AI_Unit, modified by F9bomber and Ken Miller");
...
function Update()
	...
	color.rgb_animation(Mission.TurnCounter)
